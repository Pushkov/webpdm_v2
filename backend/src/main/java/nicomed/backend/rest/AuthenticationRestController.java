...
import nicomed.backend.security.JwtTokenProvider;
...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDTO request) {
        try {
            ...
            String token = jwtTokenProvider.createToken(request.getLogin(), user.getPosition().name());
            Map<Object, Object> response = new HashMap<>();
            response.put("login", request.getLogin());
            response.put("position", user.getPosition());
            response.put("buroId", user.getBuro().getId());
